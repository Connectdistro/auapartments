...
export default function ShippingPolicyPage() {
  return (
    <LegalPageLayout eyebrow="Legal" title="Shipping Policy" updated="22 August 2026">
      ...
      <p>
        Where a signed lease or physical key handover is required, arrangements are made directly with you by the
        relevant property manager and are not covered by this page.
      </p>
    </LegalPageLayout>
  );
}
